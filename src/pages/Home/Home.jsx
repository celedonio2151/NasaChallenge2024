...
const textures = {
	Mercury:
		"https://img.freepik.com/fotos-premium/textura-mercurio-otro-mundo_889432-1298.jpg",
	Venus:
		"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRE7q_NoC49WiU1JYZAZdMEHD5sl_Bli3TiOw&s",
	Earth:
		"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKjGGrxMfKYheHNg2DnIdvvNweojYqtO9ZzQ&s",
	Mars: "https://img.freepik.com/fotos-premium/primer-plano-planeta-textura-planeta-marte_729592-1590.jpg",
	Jupiter:
		"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqWNSiRfbJKR8IWh4dsb472ZzXAbwA1t30jQ&s",
	Saturn:
		"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFEBAq2y8p5pY3Q3JR4DE-fAiyFrXeGTj6VA&s",
	Uranus:
		"https://static.vecteezy.com/system/resources/previews/001/998/851/non_2x/abstract-background-of-uranus-surface-free-vector.jpg",
	Neptune:
		"https://img.freepik.com/fotos-premium/fondo-textura-superficie-neptuno_889432-963.jpg",
...
const SolarSystem = () => {
	...
	useEffect(() => {
		...
		const planets = planetsData.map(
			({ name, size, distance, speed, eccentricity, inclination, texture }) => {
		...
		const animate = () => {
			...
			planets.forEach((planet) => {
				const meanAnomaly =
					(Date.now() * planet.speed * speedMultiplier) / 1000; // Usar speedMultiplier
		...
		<div>
			...
			>
				...
				<div className="group_buttons">
					...
					<button onClick={handleARButtonClick}>Iniciar AR</button>
				</div>
			</div>
		</div>
	);
